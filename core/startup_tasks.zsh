...
if [[ -o interactive ]]; then
    () {
        ...
        # Suppress lazy load prompts during startup tasks by default (can be overridden via ZFL_STARTUP_LAZY_QUIET)
        local ZFL_LAZY_QUIET="${ZFL_STARTUP_LAZY_QUIET:-${ZFL_LAZY_QUIET:-1}}"
